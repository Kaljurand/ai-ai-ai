...
* Allow users to:
  ...
  * Model drop-downs fetch the available models from provider APIs to present real names and estimated costs. The "Generate TTS prompt" model list combines all providers with configured API keys.
