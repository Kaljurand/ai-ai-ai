...
* Allow users to:
  ...
  * Audio files are listed in a table showing ISO timestamps and provider names.
  ...
  * Model drop-downs fetch the available models from provider APIs to present real names and estimated costs.
